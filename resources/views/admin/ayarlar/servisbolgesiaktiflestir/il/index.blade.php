    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">İl Listesi</h1>
              ...
              <span class="svg-icon svg-icon-1 position-absolute ms-6">
                ...
                <div class="card-body py-4">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_bank">
                        ...
                        <tbody class="text-gray-600 fw-bold"> @foreach($iller as $il) <tr class="text-center">

                            <td>{{$il->il_adi}}</td>
                            <td>{{$il->site_title}}</td>
                            <td>{{$il->site_description}}</td>
                            <td>{{$il->site_keyword}}</td>
                            <td>@if($il->durum == 1) Aktif @else Pasif @endif </td>
                            <td class="text-end">
                                <a href="{{ route('admin.ilUpdate',['id'=>$il->id])}}" class="menu-link px-3">
