        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">İl Güncelleme</h1>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post" data-select2-id="select2-data-kt_post">
            <div id="kt_content_container" class="container-xxl" data-select2-id="select2-data-kt_content_container">
                <div class="d-flex flex-column flex-lg-row" data-select2-id="select2-data-123-orsr">
                    <form action="{{route('admin.ilUpdatePost',$il_guncelle->id)}}" method="post" id="kt_invoice_form" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                                ...
                                <div class="mb-0">
                                    <div class="row gx-10 mb-5">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="mb-5">
                                                <input type="text" value="{{$il_guncelle->il_adi}}" class="form-control form-control-solid" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Seo Title</label>
                                            <div class="mb-5">
                                                <input type="text" name="site_title" value="{{$il_guncelle->site_title}}" class="form-control form-control-solid">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Seo Description</label>
                                            <div class="mb-5">
                                                <input type="text" name="site_description" value="{{$il_guncelle->site_description}}" class="form-control form-control-solid">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Seo Keyword</label>
                                            <div class="mb-5">
                                                <input type="text" name="site_keyword" value="{{$il_guncelle->site_keyword}}" class="form-control form-control-solid">
                                            </div>
                                        </div>
                                        <div class="fv-row mb-7">
                                            ...
                                            <select name="durum" class="form-select form-select-solid mb-3 mb-lg-0" required>
                                                <option value="1" {{ $il_guncelle->durum == 1 ? 'selected' : '' }}>Aktif</option>
                                                <option value="0" {{ $il_guncelle->durum == 0 ? 'selected' : '' }}>Pasif</option>
                                            </select>
                                        </div>
                                    </div>
                                    </div>
