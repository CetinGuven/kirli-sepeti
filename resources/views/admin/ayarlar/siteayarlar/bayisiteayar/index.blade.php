...
@section('title', 'Bayi Site Ayarları')
@section('content')
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Bayi Site Ayarları</h1>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post" data-select2-id="select2-data-kt_post">
            <div id="kt_content_container" class="container-xxl" data-select2-id="select2-data-kt_content_container">
                <div class="d-flex flex-column flex-lg-row" data-select2-id="select2-data-123-orsr">
                    <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10"> @if(empty($site_ayarlar)) <form action="{{route('admin.bayiSiteAyarCreate')}}" method="post" id="kt_invoice_form" enctype="multipart/form-data"> @csrf <div class="card">
                                    ...
                                    <div class="mb-0">
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="mb-5">
                                                    <input type="text" name="footer_copyright" class="form-control form-control-solid">
                                                </div>
                                            </div>
                        ...
                        </form> @else <form action="{{route('admin.bayiSiteAyarUpdate',['id'=>$site_ayarlar->id])}}" method="post" id="kt_invoice_form" enctype="multipart/form-data"> @csrf <div class="card">
