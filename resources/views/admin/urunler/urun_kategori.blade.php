        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Ürün Kategori Listesi</h1>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
              ...
              <span class="svg-icon svg-icon-1 position-absolute ms-6">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                </span>Ürün Kategori Ekle </button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body py-4">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_bank">
                            ...
                            @foreach($urun_kategorileri as $urun_kategori) <tr class="text-center">
                                <td> {{$urun_kategori->kategori_adi}} </td>
                                <td>{{$urun_kategori->aciklama}}</td>
                                <td> <img src=" {{asset("$urun_kategori->resim")}}" style="max-width: 60px; max-height: 60px;"></td>
                                <td>@if($urun_kategori->durum == 1) Aktif @else Pasif @endif </td>
                        ...
                        <path d="M11.4343 12.7344L7.25 8.55005C6.83579 8.13583 6.16421 8.13584 5.75 8.55005C5.33579 8.96426 5.33579 9.63583 5.75 10.05L11.2929 15.5929C11.6834 15.9835 12.3166 15.9835 12.7071 15.5929L18.25 10.05C18.6642 9.63584 18.6642 8.96426 18.25 8.55005C17.8358 8.13584 17.1642 8.13584 16.75 8.55005L12.5657 12.7344C12.2533 13.0468 11.7467 13.0468 11.4343 12.7344Z" fill="currentColor" />
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <div class="menu-item px-3">
                                            <a href="" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_user{{ $urun_kategori->id }}">Güncelle</a>
                                        </div>

                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.urunKategoriDestroy',['id'=>$urun_kategori->id]) }}" class="menu-link" data-kt-users-table-filter="delete_row1" onclick="return confirm('Bilgiler silinecek, devam ediyor musunuz?')"> Sil</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <div class="modal fade" id="kt_modal_edit_user{{ $urun_kategori->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content">
                                        <div class="modal-header" id="kt_modal_add_user_header">
                                            <h2 class="fw-bolder">Kategori Güncelle</h2>
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="currentColor" />
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <form id="kt_modal_add_user_form" class="form" method="POST" action="{{ route('admin.urunKategoriUpdate',['id'=>$urun_kategori->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                    <div class="fv-row mb-7">
                                                        <label class="required fw-bold fs-6 mb-2">Kategori Adı</label>
                                                        <input type="text" name="kategori_adi" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Kategori Adı" required value="{{$urun_kategori->kategori_adi}}" />
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                        <label class="required fw-bold fs-6 mb-2">Açıklama</label>
                                                        <input type="text" name="aciklama" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Açıklama yazınız" required value="{{$urun_kategori->aciklama}}" />
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <select name="durum" class="form-select form-select-solid mb-3 mb-lg-0" required>
                                                            <option value="1" {{ $urun_kategori->durum == 1 ? 'selected' : '' }}>Aktif</option>
                                                            <option value="0" {{ $urun_kategori->durum == 0 ? 'selected' : '' }}>Pasif</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="text-center pt-15">
                                                    <button id="myid{{ $urun_kategori->id }}" type="reset" class="btn btn-light me-3" data-bs-dismiss="modal">İptal</button>
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                                    <div class="modal-header" id="kt_modal_add_bank_header">
                                        <h2 class="fw-bolder">Yeni Kategori Ekle</h2>
                                        <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
                    <span class="svg-icon svg-icon-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" />
                        <rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="currentColor" />
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        <form id="kt_modal_add_bank_form" class="form" method="POST" action="{{ route('admin.urunKategoriCreate') }}" enctype="multipart/form-data">
                                            @csrf
