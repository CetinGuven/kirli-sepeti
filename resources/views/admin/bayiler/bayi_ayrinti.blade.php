@extends('layouts.adminLayout.admin_design') @section('title','user Listesi') @section('content') <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Bayi Ayrıntıları</h1>
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="card mb-5 mb-xl-10">
                    <div class="card-body pt-9 pb-0">
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{$bayi_ayrinti->bayi_adi}}</a>
                                            <a href="#">
                        ...
                        </div> @include('admin.bayiler.tab_menu')
                    </div>
                </div>
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    <div class="card-header cursor-pointer">
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Bayi Detayları</h3>
                        </div>
                        {{--                        <button class="btn btn-primary" onclick="openModal()">Profil Güncelle</button>--}}
                    </div>
                    <div class="card-body p-9">
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">Bayi Adı</label>
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{$bayi_ayrinti->bayi_adi}}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">Telefon</label>
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{$bayi_ayrinti->phone_number}}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">Email</label>
                            <div class="col-lg-8 fv-row">
                                <span class="fw-bold text-gray-800 fs-6">{{$bayi_ayrinti->email}}</span>
                            </div>
                        </div>
